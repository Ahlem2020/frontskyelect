            ...
            <Col md={12}>
              <Card>
                <Row className="row-sm">
                  <Col lg={6} xl={5} className=" d-none d-lg-block details " style={{ backgroundColor: "#5759a1" }}>
                      ...
                      <div className="row row-sm">
                        <div className="card-body main-profile-overview mt-3 mb-3">
                          ...
                          <form onSubmit={unlockScreen}>
                            ...
                            <button
                              type="submit"
                              className="btn ripple btn btn-block mt-4"
                              style={{ backgroundColor: "#5759a1", color: "white" }}
                            >
                              Déverrouiller
                            </button>
                            {error && (
